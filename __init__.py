...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:9813307Et@@localhost/sd3a_login'
...
facebook_id = '324479129124313'#os.getenv("sd3aFacebookID")
print(facebook_id)
facebook_secret = '0bf034de99c772ccdd4f8da74edbedf2'#os.getenv("sd3aFacebookSecret")
